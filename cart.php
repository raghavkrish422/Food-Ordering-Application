  ...
  <div class="cart-details ">
            ...
            <li class="d-flex justify-content-between align-items-center mb-3 list-group-item">
              ...
              <div class="mt-1">
                <div class="d-flex flex-row justify-content-between align-items-start quantity-price">
                  <div>
                    $<span class="item-price"><?= number_format($item['price'] ?? 0, 2) ?></span> x <span class="item-quantity"><?= $item['quantity'] ?></span>
                  </div>
                </div>
                <div class="d-flex flex-row justify-content-end align-items-end">
                  <span class="badge rounded-pill text-light p-2 mt-2 item-total-price" style="background-color: #fb4a36;">$<?= number_format($item['total_price'] ?? 0, 2) ?></span>
                </div>
              </div>
    ...
    <div class="order-summary">
      ...
      <div class="summary-details">
        ...
        <p> <span id="delivery-fee">0.00</span></p>
      </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateDeliveryFee() {
        ...
        deliveryFee = selectedPaymentMode === 'Takeaway' ? 0 : 10;
        updateSummary();
      }
      ...
      function updateQuantity(element, change, isInput = false) {
        ...
        itemContainer.querySelector('.item-total-price').textContent = '$' + itemTotalPrice;
