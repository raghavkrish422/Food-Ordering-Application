...
$deliveryFee = ($_POST['payment_mode'] === 'Takeaway') ? 0 : 10;
        ...
        <?php foreach ($itemDetails as $item) : ?>
          <div class="order-item d-flex align-items-center">
            ...
            <div class="ms-1 row d-flex justify-content-between w-100">
              ...
              <div class="col d-flex flex-column justify-content-center">
                <div class="d-flex flex-row justify-content-end align-items-center mt-2"> $<?= number_format($item['price'], 2) ?> x <?= htmlspecialchars($item['quantity']) ?></div>
                <div class="d-flex flex-row justify-content-end align-items-start mb-2">
                  <span class="badge rounded-pill text-light p-2 mt-2 item-total-price" style="background-color: #fb4a36;">$<?= number_format($item['total_price'], 2) ?></span>
                </div>
              </div>
            </div>
          </div>
